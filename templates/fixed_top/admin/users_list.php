<div class="page-header">
	...
	<p>By default record of the admin will not be displayed.</p>
	<p>User can be edited or deleted by only admin. If you are looking demo then you can not do this.</p>
</div>
	...
	<?php
		foreach ($users as $user) { 
			...
			<tr>
				...
				<td data-title="Is Active"><?php if($user['is_active']){ echo 'Yes';}else{ echo 'No';} ?></td>
